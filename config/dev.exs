...
config :stock_tracker, StockTrackerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "mgeBvBvP+kl31ATJMKUyK7s2uhA60CFTwC6iCJOeL/3gL0uKO3XHs6ZhiMk0K0z8",
  watchers: [
...
config :stock_tracker, StockTrackerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/stock_tracker_web/(live|views)/.*(ex)$",
      ~r"lib/stock_tracker_web/templates/.*(eex)$"
    ]
  ]
